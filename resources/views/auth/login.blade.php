                ...
                <ul class="navbar-nav ml-auto flex-nowrap login-box-msg">
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown role=" button"
                            ...
                            <span
                                class="flag-icon flag-icon-{{ Config::get('app.languages')[App::getLocale()]['flag-icon'] }}"></span>
                            {{ Config::get('app.languages')[App::getLocale()]['display'] }}
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">

                            @foreach (Config::get('app.languages') as $lang => $language)
                                @if ($lang != App::getLocale())
                                    <a href="locale/{{ $lang }}" class="dropdown-item">
