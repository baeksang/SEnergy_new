...
function initializeModalPage() {
  ...
  $('#select-level option[value=' + userLevel['id'] + ']').prop('selected', 'selected').change(); // userRegion.forEach
  ...
  userRegions.forEach(function (item, index) {
    $('#select-region option[value=' + item.id + ']').prop('selected', 'selected').change(); // $('#select-level').append(
